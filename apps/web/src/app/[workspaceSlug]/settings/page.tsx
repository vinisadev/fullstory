...
export default async function WorkspaceSettingsPage({
  ...
  const { apiKeys } = await auth.api.listApiKeys({ headers: reqHeaders });
    ...
    <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-6 p-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Personal tokens for programmatic access (e.g., the Full Story MCP
            server). Keys belong to your user account and are usable across
            every workspace you have access to.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <ApiKeysSection
